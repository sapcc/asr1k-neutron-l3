...
from asr1k_neutron_l3.models.netconf_yang.nat import StaticNat,DynamicNat
...
class DeviceCleanerMixin(object):
    ...
    L3_ENTITIES = [RouteMap,Prefix,AccessList,StaticNat, DynamicNat, VrfRoute,BDIInterface, VrfDefinition]
