...
from asr1k_neutron_l3.models.netmiko_legacy import netmiko_base
from asr1k_neutron_l3.models.netconf_yang.ny_base import retry_on_failure

LOG = logging.getLogger(__name__)

class StaticNatList(netmiko_base.NetmikoBase):
...
class StaticNat(netmiko_base.NetmikoBase):
...
class DynamicNat(netmiko_base.NetmikoBase):
